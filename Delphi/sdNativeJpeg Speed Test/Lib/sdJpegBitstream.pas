...
uses
  Windows, Classes, SysUtils, sdJpegConsts, sdJpegTypes;
...
type
  ...
  public
    ...
    function GetBits(Count: integer): dword;
  ...
  public
    ...
    procedure PutBits(Bits: dword; Count: integer); virtual;
  ...
  public
    ...
    procedure PutBits(Bits: dword; Count: integer); override;
...
function TsdBitReader.GetBits(Count: integer): dword;
begin
...
begin
  ...
  begin
    if FNextInMem = FLastInMem then break;
    if FNextInMem^ = $FF then
    begin
      if FHitMarker then break;
...
procedure TsdBitWriter.PutBits(Bits: dword; Count: integer);
begin
...
procedure TsdDryRunBitWriter.PutBits(Bits: dword; Count: integer);
begin
// this does nothing
end;
