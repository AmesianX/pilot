...
// PASTLWTR : 1.2
// File generated on 2004-12-07 오후 4:05:32 from Type Library described below.

// ************************************************************************  //
// Type Lib: C:\Documents and Settings\Ryu\My Documents\To Home\내 문서\개발관련 자료실\Delphi\Sample Codes\Active-X 이벤트 추가\asEventTest.tlb (1)
// LIBID: {0AF3DE67-52C9-49CC-950D-5C39EA9910B9}
// LCID: 0
// Helpfile: 
// HelpString: asEventTest Library
// DepndLst: 
...
const
  ...
  asEventTestMajorVersion = 1;
  asEventTestMinorVersion = 0;

  LIBID_asEventTest: TGUID = '{0AF3DE67-52C9-49CC-950D-5C39EA9910B9}';

  IID_IaxEventTest: TGUID = '{4A7211A8-9E01-479A-AAE7-C49A46F2D450}';
  DIID_IaxEventTestEvents: TGUID = '{684F6BE0-834D-4848-968C-E170A29D12FB}';
  CLASS_axEventTest: TGUID = '{184CC6E8-44AD-45B8-A4ED-90A6D060D278}';
...
// *********************************************************************//
  IaxEventTest = interface;
  IaxEventTestDisp = dispinterface;
  IaxEventTestEvents = dispinterface;

// *********************************************************************//
// Declaration of CoClasses defined in Type Library                       
// (NOTE: Here we map each CoClass to its Default Interface)              
// *********************************************************************//
  axEventTest = IaxEventTest;
...
// *********************************************************************//
// Interface: IaxEventTest
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {4A7211A8-9E01-479A-AAE7-C49A46F2D450}
// *********************************************************************//
  IaxEventTest = interface(IDispatch)
    ['{4A7211A8-9E01-479A-AAE7-C49A46F2D450}']
...
// *********************************************************************//
// DispIntf:  IaxEventTestEvents
// Flags:     (4096) Dispatchable
// GUID:      {684F6BE0-834D-4848-968C-E170A29D12FB}
// *********************************************************************//
  IaxEventTestEvents = dispinterface
    ['{684F6BE0-834D-4848-968C-E170A29D12FB}']
    ...
    procedure OnTest(var Msg: WideString); dispid 209;
  end;


// *********************************************************************//
// OLE Control Proxy class declaration
// Control Name     : TaxEventTest
// Help String      : axEventTest Control
// Default Interface: IaxEventTest
// Def. Intf. DISP? : No
// Event   Interface: IaxEventTestEvents
// TypeFlags        : (34) CanCreate Control
// *********************************************************************//
  TaxEventTestOnKeyPress = procedure(ASender: TObject; var Key: Smallint) of object;
  TaxEventTestOnTest = procedure(ASender: TObject; var Msg: WideString) of object;

  TaxEventTest = class(TOleControl)
  private
    ...
    FOnKeyPress: TaxEventTestOnKeyPress;
    FOnPaint: TNotifyEvent;
    FOnTest: TaxEventTestOnTest;
    FIntf: IaxEventTest;
    function  GetControlInterface: IaxEventTest;
  protected
    procedure CreateControl;
    procedure InitControlData; override;
  public
    property  ControlInterface: IaxEventTest read GetControlInterface;
    property  DefaultInterface: IaxEventTest read GetControlInterface;
  ...
  published
    ...
    property OnKeyPress: TaxEventTestOnKeyPress read FOnKeyPress write FOnKeyPress;
    property OnPaint: TNotifyEvent read FOnPaint write FOnPaint;
    property OnTest: TaxEventTestOnTest read FOnTest write FOnTest;
  end;
...
procedure TaxEventTest.InitControlData;
const
  ...
  CControlData: TControlData2 = (
    ClassID: '{184CC6E8-44AD-45B8-A4ED-90A6D060D278}';
    EventIID: '{684F6BE0-834D-4848-968C-E170A29D12FB}';
    EventCount: 9;
...
procedure TaxEventTest.CreateControl;

  procedure DoCreate;
  begin
    FIntf := IUnknown(OleObject) as IaxEventTest;
  end;
...
function TaxEventTest.GetControlInterface: IaxEventTest;
begin
  CreateControl;
  Result := FIntf;
end;
...
procedure Register;
begin
  RegisterComponents(dtlOcxPage, [TaxEventTest]);
end;
